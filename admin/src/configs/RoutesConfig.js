...
export const protectedRoutes = [
    ...
    //library
    {
        key: 'admin-supplier-managment',
        path: `${APP_PREFIX_PATH}/admin/supplier-managment`,
        component: React.lazy(() => import('views/app-views/admin/Supplier-Managment/index')),
    },
    {
        key: 'admin-producer-managment',
        path: `${APP_PREFIX_PATH}/admin/producer-managment`,
        component: React.lazy(() => import('views/app-views/admin/Producer-Managment/index')),
    },
      {
        key: 'admin-buyer-managment',
        path: `${APP_PREFIX_PATH}/admin/buyer-managment`,
        component: React.lazy(() => import('views/app-views/')),
    },
    {
        key: 'raw-material',
        path: `${APP_PREFIX_PATH}/library/raw-material`,
        component: React.lazy(() => import('views/app-views/library/Raw-Material/index')),
    },
    {
        key: 'supplier-inventory',
        path: `${APP_PREFIX_PATH}/library/supplier-inventory`,
        component: React.lazy(() => import('views/app-views/library/Supplier-inventory/index')),
    },
     {
        key: 'products',
        path: `${APP_PREFIX_PATH}/library/products`,
        component: React.lazy(() => import('views/app-views/library/Products/index')),
    },
     {
        key: 'producer-material',
        path: `${APP_PREFIX_PATH}/library/producer-material`,
        component: React.lazy(() => import('views/app-views/library/Producer-Material/index')),
    },
    {
        key: 'producer-order',
        path: `${APP_PREFIX_PATH}/library/producer-order`,
        component: React.lazy(() => import('views/app-views/library/Producer-Order/index')),
    },
     {
        key: 'buyer-products',
        path: `${APP_PREFIX_PATH}/library/buyer-products`,
        component: React.lazy(() => import('views/app-views/library/Producer-Order/index')),
    },
     {
        key: 'buyer-orders',
        path: `${APP_PREFIX_PATH}/library/buyer-orders`,
        component: React.lazy(() => import('views/app-views/library/Buyer-orders/index')),
    },
    //sales
    {
