...
router.post("/:drawingId/costing", addCostingItem);
router.put("/:drawingId/costing/:itemId", updateCostingItem);
router.get("/:drawingId/costing", getAllCostingItems);
router.delete("/:drawingId/costing/:itemId", deleteCostingItem);
