...
import { createQuote, getAllQuotes, getQuoteById, updateQuote, deleteQuote, getQuotesByCustomer, updateQuoteStatus, exportQuoteToWord, exportQuoteToExcel, exportAllQuotesToExcel } from '../controllers/quote.controller.js';
...
router.get('/export/excel',authenticate, exportAllQuotesToExcel); // Add proper Excel export function
